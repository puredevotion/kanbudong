...
/** market-checkout — generated from DESIGN.md §7. IDS notation verbatim; ui/glyphs.tsx draws it. */
export const MARKET_CHECKOUT: CategoryContent = {
  low: [
    [
      ...
      { hanzi: '超市', pinyin: 'chāoshì', nl: 'supermarkt' },
    ],
  ],
  mid: [
    [
    ...
    [
      ...
      { hanzi: '便利店', pinyin: 'biànlìdiàn', nl: 'buurtwinkel' },
    ],
    [
      'At the till. What does it mean?',
      ...
      { hanzi: '收银台', pinyin: 'shōuyíntái', nl: 'kassa' },
    ],
    [
      'At the till. What does it mean?',
      ...
      { hanzi: '结账', pinyin: 'jiézhàng', nl: 'afrekenen' },
    ],
    [
      'At the till. What does it mean?',
      ...
      { hanzi: '扫码', pinyin: 'sǎomǎ', nl: 'scannen, QR-code scannen' },
    ],
    [
      'At the till. What does it mean?',
    ...
    [
      ...
      { hanzi: '千', pinyin: 'qiān', nl: 'duizend' },
    ],
    [
      'At the till. What does it mean?',
      ...
      { hanzi: '万', pinyin: 'wàn', nl: 'tienduizend' },
    ],
  ],
  high: [
    [
      ...
      { hanzi: '亿', pinyin: 'yì', nl: 'honderd miljoen' },
    ],
    [
      'At the till. What does it mean?',
      ...
      { hanzi: '壹', pinyin: 'yī', nl: '1, schrijfwijze op documenten' },
    ],
    [
      'At the till. What does it mean?',
      ...
      { hanzi: '贰', pinyin: 'èr', nl: '2, schrijfwijze op documenten' },
    ],
    [
      'At the till. What does it mean?',
