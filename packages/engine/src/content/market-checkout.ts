...
export const MARKET_CHECKOUT: CategoryContent = {
  ...
  mid: [
    ...
    [
      ...
      0,
      'bǎi · honderd. 一 top, 白 bottom. Below the myriad break, so it behaves as a European reader expects.',
    ],
    [
      '千 — you see this on a sign. What does it mean?',
      ['thousand', 'settle up, pay', '2, capital form', 'freeze, −18 °C'],
      0,
      'qiān · duizend. 丿 top, 十 bottom. Last unit before the break.',
    ],
    [
  ...
  high: [
    ...
    [
      ...
      0,
      'yī · 1, schrijfwijze op documenten. 士 top, (冖 top, 豆 bottom) bottom. A 100-yuan note reads 壹佰圆 — recognising this is the difference between reading a banknote and looking at one.',
    ],
    [
      '贰 — you see this on a sign. What does it mean?',
      ['2, capital form', 'settle up, pay', 'kilogram = 2 斤', 'garments, items, matters'],
      0,
      'èr · 2, schrijfwijze op documenten. 弋 wrapping, (二 top, 贝 bottom) inside — carries both the 二 it replaces and the money component 贝, the only capital form that is partly guessable.',
    ],
    [
      '叁 — you see this on a sign. What does it mean?',
      ['3, capital form', 'half', '50 g, one tenth of a 斤', 'hundred'],
      0,
      'sān · 3, schrijfwijze op documenten. (厶 top, 大 bottom) top, 三 bottom — likewise contains its own 三. Mainland form; documents set in traditional type use 叄. After these three, 肆伍陆柒捌玖 follow the same logic and are deferred.',
    ],
  ],
};
