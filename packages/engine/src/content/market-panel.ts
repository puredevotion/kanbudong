...
export const MARKET_PANEL: CategoryContent = {
  ...
  mid: [
    ...
    [
      ...
      { hanzi: '号', pinyin: 'hào', nl: 'dag (spreektaal); nummer', en: 'day of month (spoken); number' },
      undefined,
      { tier: 1, freqRank: 487 },
    ],
    [
      ...
      { hanzi: '时', pinyin: 'shí', nl: 'uur; tijd', en: 'o\'clock; time' },
      undefined,
      { tier: 1, freqRank: 25 },
    ],
    [
      ...
      { hanzi: '点', pinyin: 'diǎn', nl: 'uur (spreektaal)', en: 'o\'clock (spoken)' },
      undefined,
      { tier: 1, freqRank: 128 },
    ],
    [
