...
export const STREET_WAY: CategoryContent = {
  low: [
    [
      ...
      ['go straight ahead', 'turn back', 'no through road', 'pedestrian street'],
      0,
    ...
    [
      'On a street sign. What does this mean?',
      ['no through road, dead end', 'go straight ahead', 'information desk', 'lift, elevator'],
      0,
  ...
  mid: [
    [
      'On a street sign. What does this mean?',
      ['pedestrian street', 'no through road, dead end', 'lift, elevator', 'go straight ahead'],
      0,
    ...
    [
      ...
      ['lift, elevator', 'pedestrian street', 'information desk', 'no through road, dead end'],
      0,
  ...
  high: [
    [
      'On a mall directory. What does this mean?',
      ['information desk', 'lift, elevator', 'pedestrian street', 'go straight ahead'],
      0,
    ...
    [
      'On a street sign. What does this mean?',
      ['one-way street', 'pedestrian street', 'no through road, dead end', 'information desk'],
      0,
