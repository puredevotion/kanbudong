...
export const TRANSIT_TICKET: CategoryContent = {
  low: [
    [
      ...
      0,
      'diàn · winkel. 广 wrapping, 占 inside — same 占 as 站; 广 recurs in 座, 库, 床 but not 厂房, since 厂 U+5382 differs from 广 U+5E7F and 广 = 丶 top, 厂 bottom contains it: a foil, not a family. Tail of 药店, 书店, 花店, 便利店, 眼镜店 — highest-yield head, 6:1.',
    ],
  ],
  mid: [
    [
    ...
    [
      ...
      0,
      'pù · winkeltje. 钅 left, 甫 right. Reads pù, not pū. 铺 pù, 捕 bǔ, 浦 pǔ share a rime, not an initial: a memory hook, not a reading predictor.',
    ],
    [
    ...
    [
      ...
      0,
      'guǎn · gelegenheid. 饣 left, 官 right — 饣 is on 43 characters against 12 for 食, a fact about the inventory that helps a player remember 馆 and says nothing about what a 馆 sells: 面馆 and 茶馆 are food, 宾馆 and 图书馆 are not. The head narrows, it does not decide.',
    ],
    [
      '城 — you see this on a sign. What does it mean?',
      ['large retail complex', 'bound for', 'platform', 'exit'],
      0,
      'chéng · markthal, centrum. 土 left, 成 right, rank 150. 美食城, 电脑城 — a "city" of one product type. The character is easy, the shop sense is not.',
    ],
    [
  ...
  high: [
    ...
    [
      ...
      0,
      'chēxiāng · rijtuig, wagon. Band 7–9; 厢 is rank 2,537, outside a top-1500 bank, in regardless. 厂 wrapping, 相 inside, the cheap 厂 cluster.',
    ],
    [
    ...
    [
      ...
      0,
      'qǔpiào · ticket ophalen. Absent from HSK. 取 = 耳 left, 又 right, rank 327.',
    ],
  ],
};
