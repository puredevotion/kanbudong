...
/** transit-ticket — generated from DESIGN.md §7. IDS notation verbatim; ui/glyphs.tsx draws it. */
export const TRANSIT_TICKET: CategoryContent = {
  ...
  mid: [
    ...
    [
      ...
      { hanzi: '铺', pinyin: 'pù', nl: 'winkeltje' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '行', pinyin: 'háng', nl: 'handelshuis' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '馆', pinyin: 'guǎn', nl: 'gelegenheid' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '城', pinyin: 'chéng', nl: 'markthal, centrum' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '场', pinyin: 'chǎng', nl: 'terrein, plein' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '中心', pinyin: 'zhōngxīn', nl: 'centrum' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '市场', pinyin: 'shìchǎng', nl: 'markt' },
    ],
  ],
  high: [
    [
      ...
      { hanzi: '高铁', pinyin: 'gāotiě', nl: 'hogesnelheidstrein' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '火车', pinyin: 'huǒchē', nl: 'trein' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '候车', pinyin: 'hòuchē', nl: 'wachten op de trein' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '检票', pinyin: 'jiǎnpiào', nl: 'kaartcontrole' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '车厢', pinyin: 'chēxiāng', nl: 'rijtuig, wagon' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '身份证', pinyin: 'shēnfènzhèng', nl: 'identiteitsbewijs' },
    ],
    [
      'At the ticket hall. What does it mean?',
      ...
      { hanzi: '取票', pinyin: 'qǔpiào', nl: 'ticket ophalen' },
    ],
  ],
};
