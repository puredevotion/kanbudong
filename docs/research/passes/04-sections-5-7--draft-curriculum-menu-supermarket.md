...
Two honest caveats. The QR shift is practitioner-derived market observation, not a literature claim — it needs a field check before it drives more than one template. And this template is the *only* place where character reading genuinely beats camera OCR, because a mini-programme running on your own screen cannot be photographed by a second phone. That is a promotion argument, not a demotion one.
...
Chinese food labels do not print an expiry date. They print a production date and a *duration*, and you add them yourself.
...
| 买一送一 | mǎi yī sòng yī | buy one get one free | 1+1 gratis | 1 | Every character in the top 900. Absent from every HSK level. Sandhi: spoken *mǎi yí sòng yī* |
